...
var electronLocalshortcut = __webpack_require__(/*! electron-localshortcut */ "./node_modules/electron-localshortcut/index.js");
...
function createWindow() {
  ...
  electron__WEBPACK_IMPORTED_MODULE_0__["globalShortcut"].register("ESC", function () {
    var wins = electron__WEBPACK_IMPORTED_MODULE_0__["BrowserWindow"].getAllWindows();

    if ((wins === null || wins === void 0 ? void 0 : wins.length) > 0) {
      wins.filter(function (x) {
        return x.isAlwaysOnTop();
      }).map(function (x) {
        return x.hide();
      });
    }
